...
public class Midterms {
    public static void main(String[] args) {
        ArrayList<Record> collectInput = new ArrayList<>();
        mainMenu(collectInput);
    }
    public static void addItem(ArrayList<Record> collectInput){
        //Add entry
        String a = JOptionPane.showInputDialog("How many entries would you like to add?");
        int add = Integer.parseInt(a);
        for(int i = 0; i < add; i++){
            Record newRecord = new Record(null, null);
    ...
    public static void deleteItem(ArrayList<Record> collectInput){
        //Delete entry
    ...
    public static void viewItem(ArrayList<Record> collectInput){
        //View entry
        String sentence = "";
        int input = 1;
        for(Record r : collectInput){
    ...
    public static void updateItem(ArrayList<Record> collectInput){
        //Update entry
        String sentence = "";
        int input = 1;
        for(Record r : collectInput){
    ...
    public static void mainMenu(ArrayList<Record> collectInput){
        //Main menu
